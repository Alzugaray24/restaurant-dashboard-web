...
// Usamos iconos básicos de HTML para evitar problemas con librerías de iconos
      ...
      <div className="dashboard-sidebar">
        <div>
          <div className="mb-10">
            ...
            <p className="text-xs text-secondary">Restaurant Dashboard</p>
          </div>

          <nav className="space-y-6">
            <NavItem icon={homeIcon} label="Dashboard" isActive={true} />
            <NavItem icon={cartIcon} label="Orders" />
            <NavItem icon={customersIcon} label="Customers" />
            <NavItem icon={dishesIcon} label="Dishes" />
            <NavItem icon={menuIcon} label="Menus" />
          </nav>
        </div>

        <div>
          <div className="bg-[var(--color-primary-light)] p-4 rounded-lg mb-4">
            <div className="flex items-start gap-3">
              <div className="bg-white p-2 rounded-lg">
                <span className="text-xl">👨‍🍳</span>
              </div>
              <div>
                <p className="text-xs text-[var(--color-primary)]">Please update your</p>
                <p className="text-xs text-[var(--color-primary)] font-semibold">KYC/Food license</p>
              </div>
            </div>
            <PrimaryButton className="mt-3 w-full bg-white text-[var(--color-primary)] text-xs py-2 rounded-lg border border-green-200">
              Add Papers
            </PrimaryButton>
          </div>
